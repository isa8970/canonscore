          ...
          <div className="flex items-center grow justify-end gap-5">
            <div className="relative w-full max-w-sm hidden md:block">
              <input
                ...
                className="w-full bg-zinc-900 border border-white/5 rounded-full py-1.5 px-11 text-xs text-(--text) focus:outline-none focus:border-(--accent)/50 focus:ring-1 focus:ring-(--accent)/50 transition-all placeholder:text-(--text) placeholder:opacity-30"
              />
              <svg
